          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col justify-center">
                <h1 className="text-lg font-extrabold text-zinc-100 tracking-tight leading-none">NoiseSniffer</h1>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                className={`flex items-center gap-2 px-4 py-2 rounded-xl border transition-all ${
                  isConnected ? "bg-green-950/30 border-green-900/50 text-green-400" : "bg-red-950/30 border-red-900/50 text-red-400"
                }`}
              >
                {isConnected ? (
                  <>
