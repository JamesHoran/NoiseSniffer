...
from audio_samples import engine as audio_engine
...
class Rule(BaseModel):
    ...
    frequency_boost: float = 1.0  # Volume boost
    instrument: str = "piano"  # Instrument: piano, guitar, flute, trumpet, bells, chiptune, synth
